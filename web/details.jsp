            ...
            fn(document).ready(function(){
                ...
                fn.ajax({
                    ...
                    success: function(result) {
                        var dom = fn(result);
                        fn("#categories").hide().html(dom).fadeIn('def');
                    }
                });

                //get and display book information with specified id
                fn.ajax({
                    type: "GET",
                    url: "GetBookDetails?id=${param.id}",
                    dataType: "html",
                    error: function(error){
                        fn("#content").hide().html("<b><span class='red'>An error occured: " +
                            error.status + "<br />Details: " + error.statusText +
                            "</span></b>").fadeIn('def');
                    },
                    success: function(result) {
                        var dom = fn(result);
                        fn("#content").hide().html(dom).fadeIn('def');
                        initLightbox();
                    }
                });
            });
